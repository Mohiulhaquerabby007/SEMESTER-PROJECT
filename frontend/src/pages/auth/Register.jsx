    ...
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-8"
      ...
      <div className="w-full animate-slide-up" style={{ maxWidth: "520px", position: "relative", zIndex: 1 }}>
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-base font-medium" style={{ color: "#7a7484" }}>Join QuickDrop today</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <input id="reg-name" placeholder="Full name" value={form.name} onChange={update("name")} required 
                style={{ height: "54px", borderRadius: "14px", fontSize: "15px", border: "1px solid rgba(107,70,193,0.1)", background: "#fff" }} />
            ...
            {isRider && (
              <>
                ...
                <div style={{
                  padding: "16px", borderRadius: "16px", border: "1px dashed rgba(107,70,193,0.4)",
                  background: "rgba(255,255,255,0.6)", textAlign: "center", position: "relative"
                }}>
                  <p style={{ fontSize: 13, fontWeight: 800, color: "#6b46c1", marginBottom: 8 }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
                    <span className="material-symbols-outlined" style={{ fontSize: 24, color: form.nidImage ? "#15803D" : "#7a7484" }}>
                      {form.nidImage ? "check_circle" : "add_photo_alternate"}
                    </span>
                    <span style={{ fontSize: 14, color: form.nidImage ? "#15803D" : "#7a7484", fontWeight: 700 }}>
